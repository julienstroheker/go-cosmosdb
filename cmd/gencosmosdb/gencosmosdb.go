...
import (
	...
	"github.com/leilifremont/go-cosmosdb/pkg/gencosmosdb"
)
...
func writeFile(filename string, data []byte) error {
	...
	data = packageRegexp.ReplaceAll(data, []byte("// Code generated by github.com/leilifremont/go-cosmosdb, DO NOT EDIT.\n\npackage "+*pkg))
